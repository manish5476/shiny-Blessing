...
const customerSchema = new mongoose_1.Schema({
    ...
    email: {
        ...
        lowercase: true,
        validate: {
            validator: (val) => !val || validator_1.default.isEmail(val),
...
customerSchema.statics.calculateTotalPurchasedAmountForCustomer = async function (customerId) {
    const invoices = await invoiceModel_1.default.find({ buyer: customerId }, 'totalAmount').lean();
