...
const customerSchema = new Schema<ICustomer, ICustomerModel>({
  ...
  phoneNumbers: {
    ...
    validate: {
      validator: function (this: ICustomer, v: IPhoneNumber[]): boolean {
        // If no guaranteerId is provided, at least one phone number is required.
        // If a guaranteerId IS provided, phone numbers are optional.
  ...
  guaranteerId: { type: Schema.Types.ObjectId, ref: 'Customer' }, // Optional by default
